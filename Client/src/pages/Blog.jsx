  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        <p className='inline-block py-1 px-4 rounded-full mb-6 border text-sm border-primary/35 bg-primary/5 font-medium text-primary'>Satyarth Shukla</p>
      </div>
